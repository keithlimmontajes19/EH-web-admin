...
const EditSchedules = (props: any): ReactElement => {
  const { isModalVisible, setIsModalVisible, callingSchedules, data } = props;
      ...
      if (schedID) {
        Promise.all([
          ...
          .then(() => {
            ...
            setLoading(false);
            callingSchedules();
            notificationAlert('success', 'Schedule edit success!', () => {});
          ...
          .catch(() => {
            setLoading(false);
            notificationAlert('error', 'Schedule edit failed!', () => {});
          });
      }
      return Promise.resolve(response);
    } catch (err) {
  ...
  return (
    <Container>
      ...
      >
        <ColumnText>Edit Schedule</ColumnText>
